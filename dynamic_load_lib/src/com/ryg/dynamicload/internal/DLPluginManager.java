...
public class DLPluginManager {
    ...
    private final HashMap<String, DLPluginInfo> mPackagesHolder = new HashMap<String, DLPluginInfo>();
     ...
     * @param dexPath
     */
    public DLPluginInfo loadApk(String dexPath) {
     ...
     * @return
     */
    public DLPluginInfo loadApk(final String dexPath, boolean hasSoLib) {
        ...
        DLPluginInfo pluginPackage = preparePluginEnv(packageInfo, dexPath);
        if (hasSoLib) {
            copySoLib(dexPath);
        }
     ...
     * @return
     */
    private DLPluginInfo preparePluginEnv(PackageInfo packageInfo, String dexPath) {

        DLPluginInfo pluginPackage = mPackagesHolder.get(packageInfo.packageName);
        ...
        pluginPackage = new DLPluginInfo(dexClassLoader, resources, packageInfo);
    ...
    public DLPluginInfo getPackage(String packageName) {
    ...
    public int startPluginActivityForResult(Context context, DLIntent dlIntent, int requestCode) {
        ...
        DLPluginInfo pluginPackage = mPackagesHolder.get(packageName);
        if (pluginPackage == null) {
        ...
        loadPluginClass(pluginPackage.classLoader , "com.baidu.component.host.activity.MainContentActivity");
    ...
    private String getPluginActivityFullPath(DLIntent dlIntent, DLPluginInfo pluginPackage) {
        String className = dlIntent.getPluginClass();
